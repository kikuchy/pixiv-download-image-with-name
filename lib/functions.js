...
var selectDateParser = function(){
    var workList = document.evaluate('//*[@id="wrapper"]/div[3]/div[1]/div/nav/ul/li[2]/a', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue,
...
var getUserId = function(){
    var link = document.evaluate('//*[@id="wrapper"]/div[3]/div[2]/div/div[1]/a', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue,
    cont = link.href,
    idx = cont.lastIndexOf("=");
    return parseInt(cont.substr(idx + 1), 10);
};
...
var getIllustTitle = function(){
    var header = document.evaluate('//*[@id="wrapper"]/div[3]/div[1]/div/section[1]/h1', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue;
    return header.innerText;
};

var getUserName = function(){
    var header = document.evaluate('//*[@id="wrapper"]/div[3]/div[2]/div/div[1]/a/h1', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue;
    return header.innerText;
};

var getPostDateString = function(){
    var li = document.evaluate('//*[@id="wrapper"]/div[3]/div[1]/div/section[1]/ul/li[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue;
    return li.innerText;
};
