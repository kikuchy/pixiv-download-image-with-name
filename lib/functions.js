...
var getIllustTitle = function(){
    var header = document.evaluate('//*[@id="wrapper"]/div[1]/div[1]/div/section[1]/div[2]/h1', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue;
...
var getPostDateString = function(){
    var li = document.evaluate('//*[@id="wrapper"]/div[1]/div[1]/div/section[1]/div[2]/ul/li[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue;
    return li.innerText;
};
