...
var selectDateParser = function(){
    var workList = document.evaluate('//*[@id="wrapper"]/div[2]/div[1]/div/nav/ul/li[2]/a', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue,
...
var parseJapaneseStyleDate = function(dateString){
    ...
    ret.setYear(reg[1]);
    ret.setMonth(reg[2] - 1);
    ret.setDate(reg[3]);
    ret.setHours(reg[4]);
    ret.setMinutes(reg[5]);
    return ret;
};
...
var getUserId = function(){
    var link = document.evaluate('//*[@id="wrapper"]/div[2]/div[2]/div/div[1]/a', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue,
    cont = link.href,
    idx = cont.lastIndexOf("=");
    return parseInt(cont.substr(idx + 1), 10);
};
...
var getIllustTitle = function(){
    var header = document.evaluate('//*[@id="wrapper"]/div[2]/div[1]/div/section[1]/h1', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue;
    return header.innerText;
};

var getUserName = function(){
    var header = document.evaluate('//*[@id="wrapper"]/div[2]/div[2]/div/div[1]/a/h1', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue;
    return header.innerText;
};

var getPostDateString = function(){
    var li = document.evaluate('//*[@id="wrapper"]/div[2]/div[1]/div/section[1]/ul/li[1]', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue;
    return li.innerText;
};
...
var setDownloadAttributeManga = function(props, page){
    var img = document.evaluate('/html/body/img', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE,null ).singleNodeValue;
    var ext = img.src.substring(0, img.src.lastIndexOf("?"));
    ext = extsubstring(ext.lastIndexOf("."));
    var a = document.createElement("a");
    a.href = img.src;
